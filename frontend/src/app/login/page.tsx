...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex bg-white dark:bg-canvas-dark">
      {/* Left branding panel */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-gradient-to-br from-brand-500 via-brand-600 to-violet-600 items-center justify-center p-12">
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-white/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-32 -right-16 w-96 h-96 bg-black/10 rounded-full blur-3xl" />
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-white/80 leading-relaxed">
            Boards, lists, and cards that update in real time — built to keep
            your team in sync, wherever they are.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
            ...
            <Link href="/register" className="text-brand-600 dark:text-brand-400 font-medium">
              Sign up
            </Link>
          </p>
        </div>
